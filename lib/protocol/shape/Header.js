...
var getGeometryType = exports.getGeometryType = function( type ){
	return geometryType;
};
var getDimension = exports.getDimension = function(type){
	if( type == "POINTZ" || type == "POLYLINEZ" || type == "POLYGONZ" || type == "MULTIPOINTZ" )
		 return 3;
	else return 2;
};
