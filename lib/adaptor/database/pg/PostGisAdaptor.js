 ...
 * 
 */
var select = exports.select = function select( layer ,bounds, callback, lastCallback ){
	if(typeof layer !== "undefined" &&
		...
		for(var i=0;i<len;i++){
			...
			query = query + "( SELECT "+ layer.cols.join() +", ST_AsGeoJSON("+geometryColumnName+") AS geometry  , "+i+" AS conditionId" ;
...
var setExtent = exports.setExtent = function( layer, bounds, callback, lastCallback ){
	connect(function(){
...
var returnTest = function(){
	return [ { gid: 15,
	    ...
	    dcb_se: '1',
	    hgo_frst_c: '20110722',
	    frst_regr_: 'YANGJU_JOB          ',
	    hgo_last_m: '20110722',
	    last_cort_: 'YANGJU_JOB          ',
	    geometry: '{"type":"Point","coordinates":[195600.456000000005588,469446.231000000028871]}',
	    conditionid: 0 } ];
}